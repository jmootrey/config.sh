...
echo "3. eConapp Version: "	$econapp
echo "4. Base Image File: " $iso
echo "5. Database Files:"
echo "	CWR450-2000: " ${dbfiles[1]}
echo "	CWR450-5000: " ${dbfiles[2]}
echo "6. Update System with EMTEQ package: "
echo " "
while : ; do
  ...
  case $junk in
    ...
    5) echo "Warning - Selecting the wrong file will cause configurations to fail!"
       echo " "
       cnt=1
